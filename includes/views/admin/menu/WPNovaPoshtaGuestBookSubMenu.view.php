<!-- Ссылка ссылаеться на страницу гостевой книги только у нее добавлен $_GET['action'] параметр &action=add_data
 ...
 -->
<a href="admin.php?page=wp_nova_poshta_control_guest_book_menu&action=add_data">
    <?php _e('Add', WPNOVAPOSHTA_PlUGIN_TEXTDOMAIN ); ?>
</a>
...
<table  border="1">
    ...
    <tr>
        ...
        <td>
            <?php _e('Actions', WPNOVAPOSHTA_PlUGIN_TEXTDOMAIN ); ?>
        </td>
    </tr>
    </thead>
    <tbody>
            ...
            <tr class="row table_box">
                ...
                <td>
                    <!-- Ссылки  ссылаються на страницу гостевой книги только у них добавлен $_GET['action'] параметр
                     ...
                     действия -->
                    <a href="admin.php?page=wp_nova_poshta_control_guest_book_menu&action=edit_data&id=<?php echo $value['id'];?>">
                        <?php _e('Edit', WPNOVAPOSHTA_PlUGIN_TEXTDOMAIN ); ?>
                    </a>
                    <a href="admin.php?page=wp_nova_poshta_control_guest_book_menu&action=delete_data&id=<?php echo $value['id'];?>">
                        <?php _e('Delete', WPNOVAPOSHTA_PlUGIN_TEXTDOMAIN ); ?>
                    </a>
