...
class WPNovaPoshtaLoaderScript
{
   ...
   private static $instance = null;
    ...
    public function loadScriptAdmin($hook){
        ...
        wp_register_script(
            WPNOVAPOSHTA_PlUGIN_SLUG.'-AdminMain', //$handle
            WPNOVAPOSHTA_PlUGIN_URL.'assets/admin/js/WPNovaPoshtaAdminMain.js', //$src
            array(
                'jquery'
            ), //$deps
            WPNOVAPOSHTA_PlUGIN_VERSION, //$ver
            true //$$in_footer
        );
        /**
...
//        wp_enqueue_script(WPNOVAPOSHTA_PlUGIN_SLUG.'-AdminMain');
        ...
        wp_register_style(
            WPNOVAPOSHTA_PlUGIN_SLUG.'-AdminMain', //$handle
            WPNOVAPOSHTA_PlUGIN_URL.'assets/admin/css/WPNovaPoshtaAdminMain.css', // $src
            array(), //$deps,
            WPNOVAPOSHTA_PlUGIN_VERSION // $ver
        );
        /**
         ...
         */
        wp_enqueue_style(WPNOVAPOSHTA_PlUGIN_SLUG.'-AdminMain');
